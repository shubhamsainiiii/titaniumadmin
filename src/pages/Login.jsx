...
//                         className="w-full h-[55px] px-5 rounded-2xl bg-[#0F172A] border border-white/10 outline-none text-white"
//                     />
...
//                     className="w-full h-[55px] rounded-2xl bg-[#D4AF37] text-[#0F172A] font-bold text-lg"
//                 >
